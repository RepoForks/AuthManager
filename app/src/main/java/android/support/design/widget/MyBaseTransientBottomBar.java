...
public abstract class MyBaseTransientBottomBar<B extends MyBaseTransientBottomBar<B>> {
    ...
    protected MyBaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content,
        ...
        mView = (BaseTransientBottomBar.SnackbarBaseLayout) inflater.inflate(
            android.support.design.R.layout.design_layout_snackbar, mTargetParent, false);
    ...
    final class Behavior extends SwipeDismissBehavior<BaseTransientBottomBar.SnackbarBaseLayout> {
        ...
        @Override
        public boolean onInterceptTouchEvent(CoordinatorLayout parent, BaseTransientBottomBar.SnackbarBaseLayout child,
                                             MotionEvent event) {
